...
namespace Breeze.WebApi {
  ...
  public class EFContextProvider<T> : ContextProvider where T : class, new() {
    ...
    private ObjectStateEntry HandleAdded(EFEntityInfo entityInfo) {
      UpdateIndependentAssociations(entityInfo);
    ...
    private void UpdateIndependentAssociations(EFEntityInfo entityInfo)
    {
        ...
        {
            Type propertyType = LookupEntityType(navigationProperty.EntityTypeName);
            string setName = GetEntitySetName(ObjectContext, propertyType);
