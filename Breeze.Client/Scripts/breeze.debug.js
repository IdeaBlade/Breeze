...
(function(factory) {
    if (typeof require === "function" && typeof exports === "object" && typeof module === "object") {
        ...
        // AMD anonymous module with hard-coded dependency on "breeze"
        define('breeze.remoteAccess.webApi',["breeze", "exports"], factory);
    } else {
        // <script> tag: use the global `breeze` object
        factory(breeze);
    }
...
(function(factory) {
    if (typeof require === "function" && typeof exports === "object" && typeof module === "object") {
        ...
        // AMD anonymous module with hard-coded dependency on "breeze"
        define('breeze.remoteAccess.odata',["breeze", "exports"], factory);
    } else {
        // <script> tag: use the global `breeze` object
        factory(breeze);
    }
...
(function(factory) {
    if (typeof require === "function" && typeof exports === "object" && typeof module === "object") {
        ...
        // AMD anonymous module with hard-coded dependency on "breeze"
        define('breeze.entityTracking.backingStore',["breeze", "exports"], factory);
    } else {
        // <script> tag: use the global `breeze` object
        factory(breeze);
    }
...
(function(factory) {
    if (typeof require === "function" && typeof exports === "object" && typeof module === "object") {
        ...
        // AMD anonymous module with hard-coded dependency on "breeze"
        define('breeze.entityTracking.ko',["breeze", "exports"], factory);
    } else {
        // <script> tag: use the global `breeze` object
        factory(breeze);
    }
...
(function(factory) {
    if (typeof require === "function" && typeof exports === "object" && typeof module === "object") {
        ...
        // AMD anonymous module with hard-coded dependency on "breeze"
        define('breeze.entityTracking.backbone',["breeze", "exports"], factory);
    } else {
        // <script> tag: use the global `breeze` object
        factory(breeze);
    }
