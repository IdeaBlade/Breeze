    ...
    **/
    ...
    function addProperties(entityType, propObj, ctor) {
        ...
        if (Array.isArray(propObj)) {
            ...
            throw new Error("The 'dataProperties' and 'navigationProperties' values must be either an array of data/nav properties or an object where each property defines a data/nav property");
        }
    }
