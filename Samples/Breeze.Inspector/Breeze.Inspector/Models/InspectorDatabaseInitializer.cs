...
namespace Breeze.Inspector.Models
{
    ...
    public class InspectorDatabaseInitializer : DropCreateDatabaseAlways<InspectorContext>
    {
        protected override void Seed(InspectorContext context)
        {
            ...
            var inspectionForms = new[] {
                    CreateBathroomForm(),
                    CreateElectricalInspection(),
                    CreateFireplaceInspection(),
                    CreateHeatingInspection(),
                    CreateKitchenInspection()
                };
