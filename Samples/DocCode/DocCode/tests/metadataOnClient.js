...
(function (testFns) {
    ...
    var namespace = "Northwind.Models";
    ...
    function addCategoryType(store) {
        var et = {
            ...
            dataProperties: {
                ...
                CategoryName: { maxLength: 4000 },
                Description: { maxLength: 4000 },
                // Picture as defined in server metadata.
                // I wouldn't add maxLength OR the "none" validator
            ...
            navigationProperties: {
                Products: {
                    ...
                    invForeignKeyNames: ["CategoryID"] // this shouldn't be necessary
                }
            }
        };
    ...
    function addProductType(store) {
        var et = {
            ...
            dataProperties: {
                ...
                QuantityPerUnit: { dataType: DT.Int32 },
                UnitPrice:       { dataType: DT.Decimal },
                UnitsInStock:    { dataType: DT.Decimal },
                UnitsOnOrder:    { dataType: DT.Decimal },
                ReorderLevel:    { dataType: DT.Decimal },
    ...
    function patchDefaults(entityTypeDef) {
        ...
        for (var key in dps) {
            if (_hasOwnProperty(dps, key)) {
                var prop = dps[key];
                // assume key part is non-nullable ... unless explicitly not (how can that be?)
        ...
        for (var key in navs) {
            if (_hasOwnProperty(navs, key)) {
                var prop = navs[key];
                // assume a navigation property is non-scaler unless told otherwise
                prop.isScalar = prop.isScalar === true;
                var entityTypeName = prop.entityTypeName;
                if (entityTypeName.indexOf(":#") === -1) {
                    // if name is unqualified, put it in the entity's own namespace
