...
define(["testFns"], function (testFns) {
    ...
    var newEm = function () {
        return new EntityManager({ serviceName: serviceName, metadataStore: metadataStore });
    };
    ...
    module("attach", {
        ...
        setup: function () {
            ...
            em.fetchMetadata(function (rawMetadata) {
                ...
                ok(!isEmptyMetadata, "got metadata from service " + serviceName);
                start();
            });
        },
        teardown: function () {
    ...
    test("add entity - no key", 3, function () {
        var em = newEm();
