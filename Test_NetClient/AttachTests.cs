...
namespace Test_NetClient {
  ...
  public class AttachTests {
    ...
    [TestMethod]
    public async Task AttachEntity() {
        ...
        var defaultValue =  TestFns.DEBUG_MONGO ? (Object) "" : (Object) 0;
        var emp = _em1.CreateEntity<Employee>(EntityState.Detached);
        Assert.IsTrue(emp.EntityAspect.GetValue(TestFns.EmployeeKeyName) == defaultValue, "id should be zero at creation");
        ...
        var id = emp.EntityAspect.GetValue(TestFns.EmployeeKeyName);
        Assert.IsTrue(id == defaultValue,
            "id should still be its default value after attachEntity whose state is " +
            emp.EntityAspect.EntityState);
    }
